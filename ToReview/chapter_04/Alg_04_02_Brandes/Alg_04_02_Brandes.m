...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Brandes's algorithm for computing Freeman's shortest-path betweenness
% centrality
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% A veriation of Dijkstra's shortest-path algorithm that computes and counts
% all shortest paths from a given origin node
% 
% INPUT:
% ------- 
% - C : the (n x n) cost matrix of a directed graph
...
% - sigma : (1 x n) vector holding the number of shortest-distance paths to
%         : each node
% - pred  : (n x n) binary matrix representing the shortest-path DAG
%         : pred(i, j) == 1 implies that node j is a predecessor of node i
%         : on a shortest path from the origin
% - S     : list of nodes reachable from the origin, in decscending order of
%         : the distance from the origin (i.e., furthest first, origin last)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Compute the dependency scores of nodes, through its recursively expression
% over the shortest-path DAG, and sum them in the betweenness scores
%
% INPUT:
% ------- 
% - bet    : (n x 1) vector holding the betweenness scores of nodes
%          : An entry of 0 represents no edge exists between the corresponding
%          : nodes
% - sigma  : (1 x n) vector holding the number of shortest-distance paths to
%          : each node
...
% - origin : the initial node
% - S      : list of nodes reachable from the origin, in decscending order of
%          : the distance from the origin (i.e., furthest node first)
% 
% OUTPUT:
% -------

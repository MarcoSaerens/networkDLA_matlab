...
%
% Description: A priority queue class for MATLAB.
%
% This is a simple min-priority queue, equipped with a table needed for
% 'decreaeKey' operation.  Each stored item is assumed to be represented
% by an integer ID in range 1..maxSize, where maxSize is the maximum 
% number of items to be stored (which must be declared at the time of
% object construction).
%

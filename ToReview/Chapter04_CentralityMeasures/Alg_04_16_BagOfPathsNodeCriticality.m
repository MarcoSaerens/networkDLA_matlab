function cr = Alg_04_16_BagOfPathsNodeCriticality(A, C, theta)
...
cr = zeros(n,1); % initialize node criticality vector
...
if sr < (1 - eps)
    ...
    for j = 1:n % loop on nodes; compute criticality on each node in turn
        ...
        pmj = PImj(:); % stack columns of PInj into a column vector
         ...
         % The criticality measure, i.e., the KL divergence between the two
         % distributions

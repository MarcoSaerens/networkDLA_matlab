...
% The vector of ones and the centering matrix
e = ones(n, 1);
H = eye(n) - (e*e')/n ;
...
% The original version of centered Markov difusion kernel matrix 
st.K_MD = H * Pt_Dw_Pt * H;

% The time-averaged version of centered Markov difusion kernel matrix
